...
public class VistaBorrarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(413, 475));
        ...
        jBBorrar.setBackground(new java.awt.Color(153, 0, 0));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jBBorrar, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jBBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBorrarActionPerformed
        ...
        for (Map.Entry<String, Cliente> cli:directorio.entrySet()){
            if (cli.getValue().getDni().equals(dni)) {
                control = true;
            }
        }
        ...
        if (!control){
            ...
            MenuPrincipal.getDirectorio().borrarCliente(dni);
    ...
    private void jBBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscarActionPerformed
        ...
        if (cliente == null){
            ...
            jTApellido.setText(directorio.get(numero).getApellido());
            jTNombre.setText(directorio.get(numero).getNombre());
            jTCiudad.setText(directorio.get(numero).getCiudad());
